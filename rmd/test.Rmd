...
formstr1=forms_str[[1]]
lmm_list=list(
  lmm_simple_all=run_lmm_multiple_genes(data_seurat, genes=rownames(data_seurat@assays$RNA$counts),config=my_config,formula_str = forms_str[[1]], n_cores=8),
  ...
  lmm_complex_all=run_lmm_multiple_genes(data_seurat, genes=rownames(data_seurat@assays$RNA$counts),config=my_config,formula_str = forms_str[[3]], n_cores=8),
  lmm_complex=run_lmm_multiple_genes(data_seurat, genes=rownames(data_seurat@assays$RNA$counts),config=my_config,formula_str = forms_str[[4]], n_cores=8)
)
```
### sub
```{r}
