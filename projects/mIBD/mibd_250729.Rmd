...
```{r}
mibd=read_xlsx("/data/kjc1/projects/#124. mIBD/Initial Dataset_merged_250729.xlsx",sheet="BioProbeCountMatrix")
...
data_st_postr_ved=subset(data_str_post, drug=="Vedolizumab")
...
plot_g6=ggvenn(list(
                   ck_pre=m.pp.ck__$gene,
                   str_pre=m.pp.str__$gene,
                   ck_post=m.pp.ck_$gene,
                   str_post=m.pp.str_$gene))
...
plot_g1=ggvenn(list(NR_ck_inf=m.r.ck.inf__$gene,
                   NR_ck_ved=m.r.ck.ved__$gene,
                   NR_ck_ust=m.r.ck.ust__$gene))
plot_g2=ggvenn(list(R_ck_inf=m.r.ck.inf_$gene,
                   R_ck_ved=m.r.ck.ved_$gene,
                   R_ck_ust=m.r.ck.ust_$gene))
plot_g3=ggvenn(list(NR_str_inf=m.r.str.inf__$gene,
                   NR_str_ved=m.r.str.ved__$gene,
                   NR_str_ust=m.r.str.ust__$gene))
plot_g4=ggvenn(list(R_str_inf=m.r.str.inf_$gene,
