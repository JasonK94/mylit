#' Derive gene-level importance from a trained meta learner (Enhanced)
#'
#' @inheritParams compute_meta_gene_importance
...
#' @export
compute_meta_gene_importance_v2 <- function(meta_result,
                                            normalize = TRUE,
