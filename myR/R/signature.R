    ...
    tryCatch(
      {
        ...
        result <- switch(m,
          ...
          wilcoxon = {
            ...
            message("DEBUG: Entering wilcoxon block")
            message(paste("DEBUG: wilcoxon nrow:", nrow(expr_mat_method)))
            message(paste("DEBUG: n_groups:", n_groups))
            print(table(target_binary))
            ...
            for (i in 1:nrow(expr_mat_method)) {
              if (n_groups == 2) {
                ...
                test <- try(wilcox.test(group1, group2), silent = FALSE)
