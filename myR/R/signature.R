    ...
    tryCatch(
      {
        ...
        result <- switch(m,
          ...
          nmf_loadings = {
            ...
            # Use NMF::nmf function explicitly to avoid do.call string issue
            # Use string "nmf" and namespace to be safe
            nmf_res <- do.call("nmf", nmf_args, envir = asNamespace("NMF"))
