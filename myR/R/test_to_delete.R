...
# ------------------------------------------------------------------------------
# Legacy wrappers retained for reference. These now delegate to analysis.R.
# ------------------------------------------------------------------------------
runMAST_v1_legacy <- function(...) {
  .Deprecated("runMAST_v1", package = "myR", msg = "Use runMAST_v1 from analysis.R")
  runMAST_v1(...)
}

runMUSCAT_v5_legacy <- function(...) {
  .Deprecated("runMUSCAT_v5", package = "myR", msg = "Use runMUSCAT_v5 from analysis.R")
  runMUSCAT_v5(...)
}

runMUSCAT2_v1_legacy <- function(...) {
  .Deprecated("runMUSCAT2_v1", package = "myR", msg = "Use runMUSCAT2_v1 from analysis.R")
  runMUSCAT2_v1(...)
}

runNEBULA_v1_legacy <- function(...) {
  .Deprecated("runNEBULA_v1", package = "myR", msg = "Use runNEBULA_v1 from analysis.R")
  runNEBULA_v1(...)
}

runNEBULA2_v1_legacy <- function(...) {
  .Deprecated("runNEBULA2_v1", package = "myR", msg = "Use runNEBULA2_v1 from analysis.R")
  runNEBULA2_v1(...)
}

runNEBULA2_v1_with_pseudobulk_legacy <- function(...) {
  .Deprecated("runNEBULA2_v1_with_pseudobulk", package = "myR", msg = "Use runNEBULA2_v1_with_pseudobulk from analysis.R")
  runNEBULA2_v1_with_pseudobulk(...)
}

runNEBULA2_v1_with_formula_legacy <- function(...) {
  .Deprecated("runNEBULA2_v1_with_formula", package = "myR", msg = "Use runNEBULA2_v1_with_formula from analysis.R")
  runNEBULA2_v1_with_formula(...)
}
