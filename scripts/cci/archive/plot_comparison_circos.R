...
# 6. Output Plots
output_base <- file.path(opt$outdir, "circos_comparison_final")

cat("4. Saving plots to:", opt$outdir, "\n")

# Use save_plot_formats
save_plot_formats("circos_comparison_final", opt$outdir, width = 18, height = 9, plot_code = function() {
    # Global Title
    par(oma = c(0, 0, 3, 0))
