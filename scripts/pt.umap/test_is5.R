...
# Test script for is5 (full stroke PBMC data)
# Data location: /data/user3/sobj/IS6_sex_added_251110.qs
...
message("▶ Running patient-level reduction test for is5 (full data)")
message("  • Data: /data/user3/sobj/IS6_sex_added_251110.qs")
...
# Load is5 data (full)
sobj_path <- "/data/user3/sobj/IS6_sex_added_251110.qs"
...
output_prefix <- "patient_dim_reduction_is5"
...
ggplot2::ggsave(
  file.path(output_dir, paste0("patient_umap_is5_", color_by, ".png")), 
  p, 
  width = 6, 
  height = 5, 
  dpi = 300
...
message("✅ Test run complete for is5.")
